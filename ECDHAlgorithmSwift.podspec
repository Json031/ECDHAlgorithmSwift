#
#  Be sure to run `pod spec lint ECDHAlgorithmSwift.podspec' to ensure this is a
...
Send the share key to the backend server, and if the backend server verifies that both are the same, it indicates successful authentication
  ...
  spec.homepage     = "https://github.com/Json031/ECDHAlgorithmSwift"
  ...
  # spec.authors            = { "Rate" => "cjfmail@foxmail.com" }
  ...
  spec.source       = { :git => "https://github.com/Json031/ECDHAlgorithmSwift.git", :tag => "#{spec.version}" }
  ...
  spec.dependency "ECDHAlgorithmiOS"
